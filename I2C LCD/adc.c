 ...
 * Funktion:	Library für Analog Digital Converter 
 * Autor :		Stefan Keller
...
uint16_t adc_read_channel(uint8_t mux)
{
	...
	for( i=0; i<16; i++ ) // Eigentliche Messung - Mittelwert aus 16 aufeinanderfolgenden Wandlungen
	{
...
{
	uint32_t delta_x47, delta_x79;		// Hilfsvariablen um die Steigung zu berechnen
	...
	/*************************************************************************
	*Da der Funktionsverlauf der PH Sonde nicht absolut linear ist wird 
	*eine 3 Punkt Kalibrierung durchgeführt. Dabei wird der Funktionsverlauf 
	*separat einmal für Ph-Wert kleiner 7 uns einmal für Ph_Wert grösser 7 berechnet
	*************************************************************************/
	// Funktionswerte berechnen falls der Ph_wert höher als 7 ist
	delta_x79 = *ph9 - *ph7;  // Die Differenz des ADC Wertes vom pH Wert 7 und 9 berechnen -> delta X für die Funktionsgleichung
	...
	// Funktionswerte berechnen falls der Ph_wert tiefer als 7 ist
	delta_x47 = *ph7 - *ph4;  // Die Differenz des ADC Wertes vom pH Wert 4 und 7 berechnen -> delta X für die Funktionsgleichung
