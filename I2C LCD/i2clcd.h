 ...
 * Funktion:	Header für Library zur Ansteuerung des Displays über den I2C Bus mit PCF8574
 * Autor :		Stefan Keller
...
*/
/*@{*/
#define LCD_I2C_DEVICE		0x70	/**< Change this to the address of your expander */
...
#define LCD_CURSORON		LCD_DISPLAYMODE | 0x06 //0x0e// LCD_DISPLAYMODE | 0x0e	/**<	Cursor on 0x02*/ 
#define LCD_CURSOROFF		LCD_DISPLAYMODE | 0x04	/**<	Cursor off */
...
void lcd_writemenue(const char *value);			//-	Write byte to display with toggle of enable-bit
